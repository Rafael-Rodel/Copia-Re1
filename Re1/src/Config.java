...
public class Config {
    ...
    public static final Itens PISTOLA = new Itens("pistola", "/imgs/pistola.png");
    public static final Itens CHAVE = new Itens("chave", "/imgs/chave.png");
    public static final Itens FACA = new Itens("faca", "/imgs/faca.png");
    public static final Itens SPRAY = new Itens("spray", "/imgs/spray.png");
    public static final Itens EMBLEMA_DOURADO = new Itens("emblema dourado", "/imgs/emblema dourado.png");
