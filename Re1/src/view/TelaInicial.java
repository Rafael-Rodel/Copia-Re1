...
public class TelaInicial extends JFrame {
    ...
    public TelaInicial() {
        ...
        ImageIcon imagem = new ImageIcon(getClass().getResource("/resources/imgs/capa.png"));
        ...
        painelPrincipal.add(labelComImagem);
    ...
    public void popHistoria(JFrame parent) {
        ...
        ok.addActionListener(ev -> {
            popup.dispose();
            JogoController.trocaCenario(parent, "HallEntrada");
        });
